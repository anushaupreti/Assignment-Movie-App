<x-admin-layout>
  ...
  <div class="w-4/5 m-auto pt-20">
    <form action="{{route('admin.movies.store')}}" method="POST" enctype="multipart/form-data">
      ...
      <label for="" class="bg-transparent text-2xl block border-b-2 rounded-sm">Release Date</label><br>
      ...
      <div class="bg-gray-lighter pt-15">
        <label class="w-44 flex flex-col items-center px-2 py-1 bg-green-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer rounded-3xl">
      ...
      <button type="submit" class="uppercase mt-15 bg-blue-500 text-gray-100 text-lg font-extrabold py-1 mx-10 my-5 px-8 rounded-3xl">
        Submit
      </button>
    </form>
  </div>
